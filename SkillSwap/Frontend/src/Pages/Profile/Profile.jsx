          ...
          <>
            <div className="profile-box">
              <div className="left-div">
                ...
                {/* Name */}
                <div className="misc">
                  <h1 className="profile-name" style={{ marginLeft: "2rem",fontWeight:"600",color:"rgb(17, 45, 78)" }}>
                    {profileUser?.name}
                  </h1>
                  {/* Rating */}
                    ...
                    user?.username !== username && (
                      <div className="buttons">
                        ...
                        <Link to={`/rating/${profileUser.username}`}>
                          <button className="report-button" style={{backgroundColor:"green"}}>Rate</button>
                        </Link>
                      </div>
                    )
                  }
              ...
              <div className="edit-links">
                ...
                <div className="portfolio-links">
                  ...
                  >
                    <img src="/assets/github1.png" className="link" alt="Github" />
                  </a>
                  <a
                    ...
                    className="portfolio-link"
                  >
                    <img src="/assets/linkedin1.png" className="link" alt="LinkedIn" />
                  </a>
                  <a
                    ...
                    className="portfolio-link"
                  >
                    <img src="/assets/profile (1).png" className="link" alt="Portfolio" />
                  </a>
                </div>
              </div>
            </div>
            ...
            {/* Bio */}
            <h3 style={{color:"rgb(17, 45, 78)",fontWeight:"600"}}>Bio</h3>
            <p className="bio" >{profileUser?.bio}</p>

            {/* Skills */}
            <div className="skills">
              <h3 style={{color:"rgb(17, 45, 78)",fontWeight:"600"}}>Skills Proficient At</h3>
              {/* Render skill boxes here */}
              <div className="skill-boxes">
                {profileUser?.skillsProficientAt.map((skill, index) => (
                  <div className="skill-box" style={{ fontSize: "16px",backgroundColor:"black" }} key={index}>
                    {skill}
                  </div>
                ))}
              </div>
            ...
            <div className="education">
              <h3 style={{color:"rgb(17, 45, 78)",fontWeight:"600"}}>Education</h3>
            ...
            {profileUser?.projects && profileUser?.projects.length > 0 && (
              <div className="projects">
                <h3 style={{color:"rgb(17, 45, 78)",fontWeight:"600"}}>Projects</h3>
