          ...
          <div className="tabs">
            <Button
              ...
              style={{
                ...
                borderBottom: "none",
                backgroundColor: showChatHistory ? "rgb(219, 226, 239)" : "#2d2d2d",
            ...
            <Button
              ...
              style={{
                ...
                borderBottom: "none",
                backgroundColor: showChatHistory ? "#2d2d2d" : "rgb(219, 226, 239)",
                    ...
                    {chats.map((chat) => (
                      <ListGroup.Item
                        ...
                        style={{
                          ...
                          marginBottom: "10px",
                          padding: "10px",
                          backgroundColor: selectedChat?.id === chat?.id ? "rgb(219, 226, 239)" : "lightgrey",
                          borderRadius: "5px",
                        }}
                      >
                        {chat.name}
          ...
          >
            ...
            {selectedChat && (
              <>
                ...
                <Button variant="info" style={{backgroundColor:"black",color:"white"}} onClick={handleScheduleClick}>
                  Request Video Call
                </Button>
              </>
            )}
                ...
                <>
                  {chatMessageLoading ? (
                    ...
                    <div className="row w-100 h-100 d-flex justify-content-center align-items-center">
                      <h6 className="row w-100 d-flex justify-content-center align-items-center" style={{color:"black",fontWeight:"600"}}>
