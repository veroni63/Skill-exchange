...
const Register = () => {
  ...
  return (
    <div className="register_page" style={{backgroundColor:"rgb(249, 247, 247)"}}>
      {loading ? (
        <div className="row m-auto w-100 d-flex justify-content-center align-items-center" style={{ height: "80.8vh" }}>
          <Spinner animation="border" variant="primary" />
        </div>
      ) : (
        <div className="register_section mb-3" style={{backgroundColor:"white",border:"none",width:"60%"}}>
          <h3 className="m-4" style={{ color: "rgb(17, 45, 78)",fontWeight:"900",textAlign:"center"}}>
        Join SkillMe
      </h3>
          <Tabs
          ...
          >
            <Tab eventKey="registration" title="Registration">
              {/* Name */}
              <div>
                <label style={{color: "rgb(17, 45, 78)",fontWeight:"600"}}>Name</label>
                <br />
                <input
                  type="text"
                  name="username"
                  ...
                  style={{
                    borderRadius: "5px",
                    border: "1px solid rgb(219, 226, 239)",
                    padding: "10px",
                    width: "100%",
                  }}
                  value={form.name}
              ...
              {/* Email */}
              <div>
                <label className="mt-3" style={{ color: "rgb(17, 45, 78)",fontWeight:"600" }}>
                  Email
                </label>
                <br />
                <input
              ...
              <div>
                ...
                <button style={{backgroundColor:"rgb(63, 114, 175)",color:"white"}} className="btn mt-3 ms-1" name="skill_proficient_at" onClick={handleAddSkill}>
                  Add Skill
                </button>
              </div>
              {/* Skills to learn */}
              <div>
                <label style={{ color: "rgb(17, 45, 78)",fontWeight:"600", marginTop: "20px" }}>Skills To Learn</label>
                <br />
                <Form.Select
                  aria-label="Default select example"
                  value={skillsToLearn}
                ...
                <button className="btn mt-3 ms-1" style={{backgroundColor:"rgb(63, 114, 175)",color:"white"}} name="skill_to_learn" onClick={handleAddSkill}>
                  Add Skill
                </button>
              </div>
              <div className="row m-auto d-flex justify-content-center mt-3">
                <button className="btn" style={{backgroundColor:"rgb(17, 45, 78)",color:"white"}} onClick={handleSaveRegistration} disabled={saveLoading}>
                  {saveLoading ? <Spinner animation="border" variant="primary" /> : "Save"}
                </button>
                <button onClick={handleNext} className="mt-2 btn " style={{backgroundColor:"rgb(63, 114, 175)",color:"white"}}>
                  Next
                </button>
              </div>
            </Tab>
            <Tab eventKey="education" title="Education">
                ...
                <div className="border border-dark rounded-1 p-3 m-1" key={edu.id}>
                  {index !== 0 && (
                    <span className="w-100 d-flex justify-content-end">
                      <button onClick={(e) => handleRemoveEducation(e, edu.id)}>
                      <X size={24} />
                      </button>
                    </span>
                  )}
                  <label style={{ color: "rgb(17, 45, 78)",fontWeight:"600"}}>Institution Name</label>
                  <br />
                  <input
                    type="text"
                    name="institution"
                  ...
                  />
                  <label className="mt-2" style={{ color: "rgb(17, 45, 78)",fontWeight:"600" }}>
                    Degree
                  </label>
                  <br />
                  <input
              ...
              <div className="row my-2 d-flex justify-content-center">
                <button
                  ...
                  }} style={{backgroundColor:"rgb(63, 114, 175)",color:"white"}}
                >
                  Add Education
                </button>
              </div>
              <div className="row m-auto d-flex justify-content-center mt-3">
                <button className="btn" style={{backgroundColor:"rgb(17, 45, 78)",color:"white"}} onClick={handleSaveEducation} disabled={saveLoading}>
                  {saveLoading ? <Spinner animation="border" variant="primary" /> : "Save"}
                </button>
                <button onClick={handleNext} className="mt-2 btn " style={{backgroundColor:"rgb(63, 114, 175)",color:"white"}}>
                  Next
            ...
            <Tab eventKey="longer-tab" title="Additional">
              <div>
                <label style={{ color: "rgb(17, 45, 78)",fontWeight:"600", marginTop: "20px" }}>Bio (Max 500 Character)</label>
                <br />
                <textarea
                  name="bio"
                  value={form.bio}
              ...
              <div className="">
                <label style={{ color: "rgb(17, 45, 78)",fontWeight:"600" }}>Projects</label>
                ...
                {form.projects.map((project, index) => (
                  <div className="border border-dark rounded-1 p-3 m-1" key={project.id}>
                    ...
                    <label style={{color: "rgb(17, 45, 78)",fontWeight:"600"}}>Title</label>
                    <br />
                    <input
                      type="text"
                      name="title"
                    ...
                    <button
                      className="btn mt-3 ms-1" style={{backgroundColor:"rgb(63, 114, 175)",color:"white"}}
                      name="tech_stack"
                      onClick={(e) => {
                ...
                <div className="row my-2 d-flex justify-content-center">
                  <button
                    className="btn w-50" style={{backgroundColor:"rgb(63, 114, 175)",color:"white"}}
                    onClick={() => {
              ...
              <div className="row m-auto d-flex justify-content-center mt-3">
                <button className="btn " style={{backgroundColor:"rgb(17, 45, 78)",color:"white"}} onClick={handleSaveAdditional} disabled={saveLoading}>
                  {saveLoading ? <Spinner animation="border" variant="primary" /> : "Save"}
                </button>
                <button onClick={handleNext} className="mt-2 btn " style={{backgroundColor:"rgb(63, 114, 175)",color:"white"}}>
                  Next
            ...
            <Tab eventKey="Preview" title="Confirm Details">
              <div>
                <h4 style={{ color:"rgb(17, 45, 78)", marginBottom: "20px" ,fontWeight:"700"}} className="link w-100 text-center">
                  Form Preview
                </h4>
                <div className="previewForm" style={{ fontFamily: "Montserrat, sans-serif", color: "#2d2d2d", marginBottom: "20px" }}>
                  ...
                  >
                    <span style={{ flex: 1, fontWeight: "bold", color: "rgb(17, 45, 78)" }}>Name:</span>
                  ...
                  <div
                    ...
                    className="link"
                  >
                    <span style={{ flex: 1, fontWeight: "bold", color: "rgb(17, 45, 78)" }}>Email ID:</span>
                  ...
                  <div
                    ...
                    className="link"
                  >
                    <span style={{ flex: 1, fontWeight: "bold", color: "rgb(17, 45, 78)" }}>Username:</span>
                  ...
                  <div
                    ...
                    className="link"
                  >
                    <span style={{ flex: 1, fontWeight: "bold", color: "rgb(17, 45, 78)" }}>Portfolio Link:</span>
                  ...
                  <div
                    ...
                    className="link"
                  >
                    <span style={{ flex: 1, fontWeight: "bold", color: "rgb(17, 45, 78)" }}>Github Link:</span>
                  ...
                  <div
                    ...
                    className="link"
                  >
                    <span style={{ flex: 1, fontWeight: "bold", color: "rgb(17, 45, 78)" }}>Linkedin Link:</span>
                    <span
                      style={{
                        width: "70vw",
                        alignItems: "center",
                  ...
                  <div
                    ...
                    className="link"
                  >
                    <span style={{ flex: 1, fontWeight: "bold", color: "rgb(17, 45, 78)" }}>Skills Proficient At:</span>
                  ...
                  <div
                    ...
                    className="link"
                  >
                    <span style={{ flex: 1, fontWeight: "bold", color: "rgb(17, 45, 78)" }}>Skills To Learn:</span>
                  ...
                  <div
                    ...
                    className="link"
                  >
                    <span style={{ flex: 1, fontWeight: "bold", color: "rgb(17, 45, 78)" }}>Bio:</span>
